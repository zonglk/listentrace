...
#import "LTFontAndColorMacros.h"
#import "UrlMacros.h"
#import "Masonry.h"
#import "LTNetworking.h"

@interface LTAlbumTableViewController ()<UIImagePickerControllerDelegate, UIPickerViewDelegate, LTAlbumTimePickerDelegate, UITextFieldDelegate>
...
- (void)viewDidLoad {
    ...
    [LTNetworking requestUrl:@"/album/resolve" WithParam:@{@"url" : self.urlString} withMethod:GET success:^(id  _Nonnull result) {
