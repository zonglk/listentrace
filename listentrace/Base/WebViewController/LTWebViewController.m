...
#import "LTJSHandler.h"
#import "LTHeaderModel.h"
#import "AESCipher.h"
#import <YYKit.h>

@interface LTWebViewController () <WKNavigationDelegate>

@property (nonatomic,strong) LTJSHandler * jsHandler;
...
- (void)setUrl:(NSString *)url {
    if (_url != url) {
        ...
        //加密header部分
        NSString *headerContentStr = [[LTHeaderModel new] modelToJSONString];
...
- (void)initWKWebView {
    ...
    _jsHandler = [[LTJSHandler alloc]initWithViewController:self configuration:configuration];
